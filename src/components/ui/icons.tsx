// @ts-nocheck
/* eslint-disable */
/* Shared SVG icon set extracted from the legacy markup. */
...
export const IconPassword = () => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="1.5"
      d="M15.5 14.5a6 6 0 1 0-5.47-3.53L2.5 18.5v3h3v-2h2v-2h2l3.53-3.53c.754.34 1.59.53 2.47.53m2-8l-1 1"
    ></path>{" "}
  </svg>
);
...
export const IconEye = () => (
  ...
  >
    ...
    <g fill="none" stroke="currentColor" strokeWidth="1.5">
      {" "}
      <path d="M21.544 11.045c.304.426.456.64.456.955c0 .316-.152.529-.456.955C20.178 14.871 16.689 19 12 19c-4.69 0-8.178-4.13-9.544-6.045C2.152 12.529 2 12.315 2 12c0-.316.152-.529.456-.955C3.822 9.129 7.311 5 12 5c4.69 0 8.178 4.13 9.544 6.045Z"></path>{" "}
...
export const IconVideo = () => (
  ...
  >
    ...
    >
      ...
      ></path>{" "}
      <path d="M14.945 12.395c-.176.627-1.012 1.07-2.682 1.955c-1.615.856-2.422 1.285-3.073 1.113a1.66 1.66 0 0 1-.712-.393C8 14.62 8 13.746 8 12s0-2.62.478-3.07c.198-.186.443-.321.712-.392c.65-.173 1.458.256 3.073 1.112c1.67.886 2.506 1.329 2.682 1.955c.073.259.073.531 0 .79Z"></path>{" "}
    </g>{" "}
  </svg>
);
...
export const IconUsers = () => (
  ...
  >
    ...
    >
      {" "}
      <path d="M16.5 20v-2.03c0-1.242-.56-2.46-1.69-2.975C13.431 14.366 11.778 14 10 14s-3.431.366-4.81.995c-1.13.515-1.69 1.733-1.69 2.975V20m17 .001v-2.03c0-1.242-.56-2.46-1.69-2.975q-.39-.18-.81-.328"></path>{" "}
      <circle cx="10" cy="7.5" r="3.5"></circle>{" "}
      <path d="M15 4.145a3.502 3.502 0 0 1 0 6.71"></path>{" "}
    </g>{" "}
  </svg>
);
...
export const IconMoney = () => (
  ...
  >
    ...
    <g
      ...
      strokeWidth="1.5"
    >
      <path d="M14.5 12.001a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0m-8.875.499H5.5m.25 0a.25.25 0 1 1-.5 0a.25.25 0 0 1 .5 0m12.875-1H18.5m.25 0a.25.25 0 1 1-.5 0a.25.25 0 0 1 .5 0" />
      <path d="M16 5.001c2.48 0 4.19.384 5.133.676c.543.168.867.683.867 1.251v9.755c0 1.115-1.228 1.954-2.324 1.747c-.94-.177-2.165-.32-3.676-.32c-4.75 0-5.89 1.806-12.855.27A1.47 1.47 0 0 1 2 16.94V6.921c0-.976.92-1.687 1.878-1.497C10.197 6.678 11.421 5 16 5" />
    </g>
  </svg>
);

export const IconTwoUsers = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1.3em"
    height="1.3em"
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="1.5"
      d="M18.001 21c0-2.267 0-3.4-.407-4.29a4.5 4.5 0 0 0-2.086-2.154c-.877-.436-2.007-.555-4.28-.55L8.773 14c-2.273 0-3.378.106-4.244.527a4.48 4.48 0 0 0-2.135 2.2C2 17.605 2 18.737 2 20.999M14.001 7a4 4 0 1 1-8 0a4 4 0 0 1 8 0m8 14c0-2.255 0-3.383-.407-4.268c-.428-.93-1.17-1.775-2.091-2.231M16.001 3.126a4.002 4.002 0 0 1 0 7.748"
    />
  </svg>
);

export const IconMice = ()=>(<svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24">
	<path d="M0 0h24v24H0z" fill="none" />
...
export const IconArrowUpLeft = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 24 24">
	<path d="M0 0h24v24H0z" fill="none" />
	<path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 6.65s-6.938-.542-7.915.435S6.65 15 6.65 15m.85-7.5l10 10" />
</svg>
);