            ...
            <div className="col-lg-3 col-md-12">
              ...
              <div className="reviews-intro" >
                ...
                <h2 className="reviews-title fw-bold">
                  {" "}
                  <span data-i18n="reviews_title_pre2">آراؤكم في</span>{" "}
                  <span
                    className="reviews-highlight"
                    data-i18n="reviews_title_highlight"
                  >
                    المحتوى
                  </span>{" "}
                </h2>{" "}
                <p className="reviews-desc" data-i18n-html="reviews_trust_html">
                  نفخر <span className="hl">بثقة</span>
                  جمهورنا، ونعتز بكل رأي يساهم في تطوير رسالتنا الإعلامية.
                </p>{" "}
              </div>{" "}
            </div>{" "}
              ...
              <div className="review-reels reels-container"  id="reelsContainer">
                ...
                <div className="reel-item" data-index="0">
                  ...
                  <div className="reel-caption">
                    {" "}
                    <p className="reel-title" data-i18n="reel_title">
                      قصة أمل من غزة: كيف تحدى الحصار
                    </p>{" "}
                    <span className="reel-views" data-i18n="reel_views">
                      200k مشاهدة
                    </span>{" "}
                  </div>{" "}
                </div>{" "}
                <div className="reel-item" data-index="1">
                  {" "}
                  <div className="reel-media">
                    {" "}
                    <video
                ...
                <div className="reel-item" data-index="2">
                  {" "}
                  <div className="reel-media">
                    {" "}
                    <video
                    ...
                    <div className="reel-seekbar " >
                      {" "}
                      <span className="reel-time " style={{height:"30px"}} >0:00</span>{" "}
                      <div className="reel-progress">
                        {" "}
                        <div className="reel-progress-fill"></div>{" "}
                      </div>{" "}
