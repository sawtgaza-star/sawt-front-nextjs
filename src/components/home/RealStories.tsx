...
export default function RealStories() {
  return (
    <>
      <section className="real-stories-section py-5 bg-white">
        {" "}
                  ...
                  <div className="rs-card">
                    ...
                    <div className="rs-card-info">
                      ...
                      <div className="rs-card-text">
                        ...
                        <p className="rs-card-full" data-i18n="rs_card1_full">
                  ...
                  <div className="rs-card">
                    ...
                    <div className="rs-card-info">
                      ...
                      <div className="rs-card-text">
                        ...
                        <p className="rs-card-full" data-i18n="rs_card2_full">
            ...
            <div className="col-lg-5 order-1 order-lg-1">
              ...
              <div className="rs-intro">
                ...
                <h2 className="rs-title fw-bold">
                  {" "}
                  <span data-i18n="rs_intro_title_pre">
                    هل لديك صوت يستحق أن
                  </span>{" "}
                  <span
                    className="rs-title-word"
                    data-i18n="rs_intro_title_word"
                  >
                    يُسمع ؟
                  </span>{" "}
                </h2>{" "}
                <p className="rs-desc" data-i18n="rs_intro_desc">
                ...
                <div className="rs-count">
                  ...
                  <span className="rs-count-text" data-i18n="realstories_count">
                    +100 قصة واقعية نقلتها صوت الى العالم
                  </span>{" "}
                </div>{" "}
                <form
                  className="rs-comment-box"
                  onSubmit={() => {
                    return false;
                  }}
                >
