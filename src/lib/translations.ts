...
export const translations: any = {
  ar: {
    ...
    // Confirmation toast shown on the page the logout button lands on
    logout_toast: "تم تسجيل الخروج بنجاح",
    logout_toast_close: "إغلاق",
    ...
    otp_attempts_left: "المحاولات المتبقية:",
    otp_verify: "التحقق",
    ...
    // Auth feedback — the API answers in Arabic only, so lib/api/messages.ts
    // matches its text back to these keys. Anything it doesn't know is shown
    // as the server sent it.
    api_email_taken: "هذا البريد مسجّل مسبقاً.",
    api_course_already_pending: "لديك طلب اشتراك قيد المراجعة لهذا الكورس.",
    api_first_name_required: "الاسم الأول مطلوب.",
    api_last_name_required: "اسم العائلة مطلوب.",
    api_email_required: "البريد الإلكتروني مطلوب.",
    api_email_invalid: "صيغة البريد الإلكتروني غير صحيحة.",
    api_password_required: "كلمة المرور مطلوبة.",
    api_password_min: "كلمة المرور يجب أن تكون 8 أحرف على الأقل.",
    // One per rule in lib/password-policy.ts — the form lists every unmet one
    api_password_uppercase: "كلمة المرور يجب أن تحتوي على حرف كبير واحد على الأقل.",
    api_password_digit: "كلمة المرور يجب أن تحتوي على رقم واحد على الأقل.",
    api_password_symbol: "كلمة المرور يجب أن تحتوي على رمز واحد على الأقل.",
    api_password_mismatch: "كلمتا المرور غير متطابقتين.",
    api_code_required: "أدخل رمز التحقق المكوّن من 6 أرقام.",
    api_code_sent: "تم إرسال رمز جديد إلى بريدك الإلكتروني.",
    // The reset flow's four confirmations, shown in the success banner
    api_code_mailed: "تم إرسال رمز التحقق إلى بريدك الإلكتروني.",
    api_code_resent: "تم إعادة إرسال رمز التحقق.",
    api_code_verified: "تم التحقق من الرمز بنجاح.",
    ...
    reel_follow: "متابعة",
    reel_unfollow: "إلغاء المتابعة",
    reel_followed: "تمت المتابعة",
    reel_close: "إغلاق",
    reel_comments_title: "التعليقات",
    reel_comments_empty: "لا توجد تعليقات بعد، كن أول من يعلّق",
    cr_content_title: "المحتوى",
    cr_content_empty: "لا يوجد محتوى لصانع المحتوى هذا بعد",
    ...
    reel_saved_toast: "تم حفظ الفيديو",
    reel_unsaved_toast: "أُزيل الفيديو من المحفوظات",
    ...
    // the count comes from the API; only the word after it is translated
    reel_views_word: "مشاهدة",
    ...
    /* --- enrollment modal (course-register/) --- */
    crs_en_title: "أكمل تسجيلك في الدورة",
    crs_en_subtitle:
      "أدخل بياناتك وسنتواصل معك لتأكيد التسجيل وتزويدك بالتفاصيل.",
    crs_en_close: "إغلاق",
    crs_en_step1: "المعلومات الشخصية",
    crs_en_step2: "البيانات الأكاديمية والمهنية",
    crs_en_step3: "أهدافك واهتماماتك",
    crs_en_fullname: "الاسم الكامل",
    crs_en_fullname_ph: "محمد احمد",
    crs_en_phone: "رقم الهاتف",
    crs_en_phone_ph: "59999999",
    crs_en_email: "البريد الالكتروني",
    crs_en_email_ph: "Mohamed@Gmail.Com",
    crs_en_country: "مفتاح الدولة",
    crs_en_country_search: "ابحث عن دولة",
    crs_en_level: "المستوى الدراسي أو المهني",
    crs_en_level_ph: "اختر مستواك الدراسي أو المهني",
    crs_en_level_school: "طالب مدرسة",
    crs_en_level_university: "طالب جامعي",
    crs_en_level_graduate: "خريج",
    crs_en_level_employed: "موظف",
    crs_en_level_freelancer: "عامل حر",
    crs_en_level_other: "أخرى",
    crs_en_attended: "هل سبق لك الالتحاق بدورة مشابهة؟",
    crs_en_yes: "نعم",
    crs_en_no: "لا",
    crs_en_interests: "أهدافك واهتماماتك",
    crs_en_interests_ph: "ما الذي تتوقع أن تعلمه من الدورة؟",
    crs_en_goal: "ما هدفك من الالتحاق بالدورة؟",
    crs_en_goal_ph: "اختر مستواك الدراسي أو المهني",
    crs_en_goal_skill: "تعلم مهارة جديدة",
    crs_en_goal_career: "تطوير مساري المهني",
    crs_en_goal_work: "الحصول على فرصة عمل",
    crs_en_goal_project: "إطلاق مشروعي الخاص",
    crs_en_goal_other: "أخرى",
    crs_en_notes: "ملاحظات إضافية",
    crs_en_notes_ph: "أي معلومات إضافية تود إضافتها (اختياري)",
    crs_en_cancel: "الغاء",
    crs_en_prev: "السابق",
    crs_en_next: "التالي",
    crs_en_submit: "تسجيل في الكورس",
    crs_en_done_title: "تم إرسال طلبك بنجاح",
    crs_en_done_text: "سنتواصل معك لتأكيد تسجيلك في:",
    crs_en_close_btn: "إغلاق",
    crs_en_sending: "جاري الإرسال...",
    crs_en_required: "هذا الحقل مطلوب",
    crs_en_already_title: "أنت مسجّل في هذا الكورس مسبقاً",
    crs_wl_title: "قائمة الانتظار",
    crs_wl_refused_title: "تعذّر الانضمام لقائمة الانتظار",
    crs_en_email_invalid: "يرجى إدخال بريد إلكتروني صحيح",
    crs_en_done_course: "الكورس:",
    crs_en_done_status: "حالة الطلب:",
  ...
  en: {
    ...
    otp_resend: "Resend",
    otp_attempts_left: "Attempts left:",
    otp_verify: "Verify",
    ...
    // Auth feedback — see the Arabic block for how these are matched.
    api_email_taken: "This email is already registered.",
    api_course_already_pending: "You already have a subscription request under review for this course.",
    api_first_name_required: "First name is required.",
    api_last_name_required: "Last name is required.",
    api_email_required: "Email is required.",
    api_email_invalid: "The email address format is invalid.",
    api_password_required: "Password is required.",
    api_password_min: "The password must be at least 8 characters.",
    api_password_uppercase: "The password must contain at least one uppercase letter.",
    api_password_digit: "The password must contain at least one number.",
    api_password_symbol: "The password must contain at least one symbol.",
    api_password_mismatch: "The two passwords do not match.",
    api_code_required: "Enter the 6-digit verification code.",
    api_code_sent: "A new code has been sent to your email.",
    api_code_mailed: "A verification code has been sent to your email.",
    api_code_resent: "The verification code has been resent.",
    api_code_verified: "The code was verified successfully.",
    ...
    reel_follow: "Follow",
    reel_unfollow: "Unfollow",
    reel_followed: "Followed",
    reel_close: "Close",
    reel_comments_title: "Comments",
    reel_comments_empty: "No comments yet — be the first to comment",
    cr_content_title: "Content",
    cr_content_empty: "This creator has no content yet",
    ...
    reel_saved_toast: "Video saved",
    reel_unsaved_toast: "Video removed from saved",
    ...
    /* --- enrollment modal (course-register/) --- */
    crs_en_title: "Complete your course registration",
    crs_en_subtitle:
      "Enter your details and we will contact you to confirm your registration and share the rest.",
    crs_en_close: "Close",
    crs_en_step1: "Personal information",
    crs_en_step2: "Academic and professional details",
    crs_en_step3: "Your goals and interests",
    crs_en_fullname: "Full name",
    crs_en_fullname_ph: "Mohamed Ahmed",
    crs_en_phone: "Phone number",
    crs_en_phone_ph: "59999999",
    crs_en_email: "Email address",
    crs_en_email_ph: "Mohamed@Gmail.Com",
    crs_en_country: "Country code",
    crs_en_country_search: "Search for a country",
    crs_en_level: "Education or professional level",
    crs_en_level_ph: "Choose your education or professional level",
    crs_en_level_school: "School student",
    crs_en_level_university: "University student",
    crs_en_level_graduate: "Graduate",
    crs_en_level_employed: "Employed",
    crs_en_level_freelancer: "Freelancer",
    crs_en_level_other: "Other",
    crs_en_attended: "Have you taken a similar course before?",
    crs_en_yes: "Yes",
    crs_en_no: "No",
    crs_en_interests: "Your goals and interests",
    crs_en_interests_ph: "What do you expect to learn from the course?",
    crs_en_goal: "What is your goal in joining the course?",
    crs_en_goal_ph: "Choose your education or professional level",
    crs_en_goal_skill: "Learn a new skill",
    crs_en_goal_career: "Grow my career",
    crs_en_goal_work: "Find a job opportunity",
    crs_en_goal_project: "Launch my own project",
    crs_en_goal_other: "Other",
    crs_en_notes: "Additional notes",
    crs_en_notes_ph: "Anything else you would like to add (optional)",
    crs_en_cancel: "Cancel",
    crs_en_prev: "Previous",
    crs_en_next: "Next",
    crs_en_submit: "Register for the course",
    crs_en_done_title: "Your request was sent successfully",
    crs_en_done_text: "We will contact you to confirm your place in:",
    crs_en_close_btn: "Close",
    crs_en_sending: "Sending...",
    crs_en_required: "This field is required",
    crs_en_already_title: "You have already applied to this course",
    crs_wl_title: "Waiting list",
    crs_wl_refused_title: "Couldn't join the waiting list",
    crs_en_email_invalid: "Please enter a valid email address",
    crs_en_done_course: "Course:",
    crs_en_done_status: "Request status:",
    ...
    crs_lesson_min: "min",
    crs_module_locked: "Locked content",
